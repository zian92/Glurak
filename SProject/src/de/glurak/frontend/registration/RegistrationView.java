...
/**
 * In der RegistrationView kann ein Benutzer des System sich einen neuen Account anlegen. Um sich zu registrieren muss man die geforderten Daten angeben.
 * 
 * @author Simon
 * 
 */
public class RegistrationView extends JPanel {
     ...
     *            der Actionlistener für die Button. null für keinen
     * @param focuslistener
     *            der FocusListener für das Enter. null für keinen
     */
    public RegistrationView(ActionListener actionlistener, FocusListener focuslistener) {
        ...
        if (actionlistener != null) b_register.addActionListener(actionlistener);
        b_register.setActionCommand("registrate");
        b_cancel = new JButton("Abbrechen");
        if (actionlistener != null) b_cancel.addActionListener(actionlistener);
        ...
        String[] countries = new String[] { "", "Belgium", "China", "Dänemark", "Deutschland", "England", "Finnland", "Frankreich", "Irland", "Italien", "Japan", "Luxemburg", "Niederlande", "Norwegen", "Österreich", "Polen", "Portugal", "Russland", "Schweden", "Schweiz", "Spanien", "Tschechien", "Vereinigte Staaten", "anderes Land" };
    ...
    /**
     * erstellt Radiobuttons für die genderleselection
     * 
     * @return Panel mit label etc
     */
    ...
    /**
     * erstellt pein Panel für die Geburtstags-Angabe
     * 
     * @return Panel mit label etc
     */
    ...
    /**
     * Fügt eine beshcreibendes label zur komponente hinzu
     * 
     * @param description
     * @param other
     *            die zu beschreibende Komponente
     * @return Panel mit label etc
     */
    ...
    /**
     * Gibt den User zurück der von den Werten in der Eingabe erzeugt wird. Er muss noch in der Datenbank registriert werden.
     * 
     * @author Entscheider
    ...
    public User getEnteredUser() {
        ...
        if (!(1 <= day && day <= 31 && 1 <= month && month <= 12 && 1900 <= year)) return null;
    ...
    private static void createAndShowView() {
        ...
        /**
         * Dimension dim = Toolkit.getDefaultToolkit().getScreenSize(); register.setLocation(dim.width/2-register.getSize().width/2-300, dim.height/2-register.getSize().height/2-150);
         **/
