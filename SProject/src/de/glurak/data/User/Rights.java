...
public class Rights {
    ...
    /*!!!Zum testen hat der Listener ersmal alle Rechte */ //TODO: ÄNDERN Für Endversion
    protected static final String[] LISTENER_RIGHTS ={LISTEN_RIGHT,MANAGE_OWN_MEDIEN,APPLICATION_TO_LABEL,MANAGE_PLAYLIST,MANAGE_ALBUM,
            LOCK_OTHER_MEDIEN,LOCK_OTHER_USER,
            MAIL_SEND,FOLLOW_USER,DO_MESSAGE,GENRE_ADD,
            ANOUNCEMENTS_RIGHTS,LISTEN_RIGHT,DO_MESSAGE,GENRE_ADD,ASSIGN_RIGHTS,
            LISTEN_RIGHT,MANAGE_OTHER_USER,MANAGE_PLAYLIST,MANAGE_ALBUM,FOLLOW_USER,DO_MESSAGE,ANOUNCEMENTS_FOR_LABEL_RIGHTS};
    /*!!!!!!!!!*/
